					...
					<div class="container pagina">
						<div class="row">
							<div class="col">
								...
								<div class="row mb-3 d-flex align-items-center tarefa">
                                    <div class="col-sm-2">17/06/21</div>
                                    <div class="col-sm-2">Delvino Lorenzetti</div>
                                    <div class="col-sm-2">Serafina Corrêa</div>
                                    <div class="col-sm-2">28 - Alojamento</div>
                                    <div class="col-sm-2">4.000,00</div>
									<div class="col-sm-2 mt-2 d-flex justify-content-between">
